...
export const AFFECTION_STAGES: AffectionStage[] = [
  ...
  },
  {
    ...
    max: 49,
    label: "친근",
    description: "읽기와 일반 대화만으로도 비교적 빠르게 오를 수 있습니다.",
    unlockHint: "따뜻한 장면, 가까운 구도 이미지, 개인적인 질문을 해금합니다.",
    gainMultiplier: 1.3,
    recommendedActions: ["계속 읽기", "상대 질문에 답하기", "호감 선택지"],
  },
  {
    key: "trust",
    min: 50,
    max: 64,
    label: "신뢰",
    description: "반복 행동보다 맥락에 맞는 대화와 선택이 중요해집니다.",
  ...
  },
  {
    ...
    max: 77,
    label: "긴장",
    description: "관계가 깊어질수록 보상 상승폭이 줄어듭니다.",
  ...
  },
  {
    ...
    gainMultiplier: 0.32,
    recommendedActions: ["분기 대화", "스토리 퀘스트", "잠금 이미지 해금"],
  },
  {
    key: "bond",
    min: 88,
    max: 94,
    label: "깊은 유대",
    description: "특별 퀘스트와 고품질 대화가 필요합니다.",
    unlockHint: "프리미엄 이미지 일부와 결말 분기 조건을 해금합니다.",
    gainMultiplier: 0.2,
    recommendedActions: ["특별 퀘스트", "캐릭터별 장문 대화", "결정적 선택"],
  },
  {
    key: "final",
    min: 95,
    max: 100,
    label: "완전 해금",
    description: "최종 단계는 일반 행동 보상만으로 거의 오르지 않습니다.",
